...
return array(
	...
	"params" => array(
		...
		array(
			...
			'edit_field_class' => 'vc_col-sm-3 vc_column',
			'description' => __( 'Leave empty to use H4 font size. Tablet and mobile font sizes are optional.', 'the7mk2' ),
			'group' => __( 'Testimonial', 'the7mk2' ),
			'dependency' => array(
				'element' => 'testimonial_name',
				'value' => 'y',
		...
		array(
			...
			'icon' => '<i class="fa fa-desktop"></i>',
			'edit_field_class' => 'vc_col-sm-3 vc_column',
			'description' => __( 'Leave empty to use H4 line height. Tablet and mobile font line heights are optional.', 'the7mk2' ),
			'group' => __( 'Testimonial', 'the7mk2' ),
			'dependency' => array(
				'element' => 'testimonial_name',
				'value' => 'y',
		...
		array(
			...
			'icon' => '<i class="fa fa-desktop"></i>',
			'edit_field_class' => 'vc_col-sm-3 vc_column',
			'description' => __( 'Leave empty to use medium font size. Tablet and mobile font sizes are optional.', 'the7mk2' ),
			'group' => __( 'Testimonial', 'the7mk2' ),
			'dependency' => array(
				'element' => 'testimonial_position',
				'value' => 'y',
		...
		array(
			...
			'icon' => '<i class="fa fa-desktop"></i>',
			'edit_field_class' => 'vc_col-sm-3 vc_column',
			'description' => __( 'Leave empty to use medium line height. Tablet and mobile font line heights are optional.', 'the7mk2' ),
			'group' => __( 'Testimonial', 'the7mk2' ),
			'dependency' => array(
				'element' => 'testimonial_position',
				'value' => 'y',
		...
		array(
			...
			'icon' => '<i class="fa fa-desktop"></i>',
			'edit_field_class' => 'vc_col-sm-3 vc_column',
			'description' => __( 'Leave empty to use large line height. Tablet and mobile font sizes are optional.', 'the7mk2' ),
			'group' => __( 'Testimonial', 'the7mk2' ),
		),
		...
		array(
			...
			'type'			=> 'colorpicker',
			'value'			=> '',
			'description' => __( 'Leave empty to use primary text color. Tablet and mobile font line heights are optional.', 'the7mk2' ),
			'group' => __( 'Testimonial', 'the7mk2' ),
		),
		array(
