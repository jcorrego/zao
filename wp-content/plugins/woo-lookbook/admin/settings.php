		...
		<div class="wrap woo-lookbook">
			...
			<form method="post" action="" class="vi-ui form">
				...
				<div class="vi-ui bottom attached tab segment" data-tab="product">
					...
					<table class="optiontable form-table">
						...
						<tr valign="top">
							...
							<td>
								<div class="vi-ui toggle checkbox">
									<input id="<?php echo self::set_field( 'link_redirect' ) ?>" type="checkbox" <?php checked( self::get_field( 'link_redirect' ), 1 ) ?> tabindex="0" class="hidden" value="1" name="<?php echo self::set_field( 'link_redirect' ) ?>" />
									<label></label>
								</div>
						...
						<tr valign="top">
							...
							<td>
								<div class="vi-ui toggle checkbox">
									<input id="<?php echo self::set_field( 'external_product' ) ?>" type="checkbox" <?php checked( self::get_field( 'external_product' ), 1 ) ?> tabindex="0" class="hidden" value="1" name="<?php echo self::set_field( 'external_product' ) ?>" />
									<label></label>
								</div>
				...
				<div class="vi-ui bottom attached tab segment" data-tab="design">
					...
					<table class="optiontable form-table">
						...
						<tr valign="top">
							...
							<td>
								<input type="text" class="color-picker" name="<?php echo self::set_field( 'icon_color' ) ?>" value="<?php echo self::get_field( 'icon_color', '#fff' ) ?>" style="background-color: <?php echo esc_attr( self::get_field( 'icon_color', '#fff' ) ) ?>" />
							</td>
						</tr>
						<tr valign="top">
							<th scope="row">
							...
							<td>
								<input type="text" class="color-picker" name="<?php echo self::set_field( 'icon_background_color' ) ?>" value="<?php echo self::get_field( 'icon_background_color', '#E8CE40' ) ?>" style="background-color: <?php echo esc_attr( self::get_field( 'icon_background_color', '#E8CE40' ) ) ?>" />
							</td>
						</tr>
						<tr valign="top">
							<th scope="row">
							...
							<td>
								<input type="text" class="color-picker" name="<?php echo self::set_field( 'icon_border_color' ) ?>" value="<?php echo self::get_field( 'icon_border_color', '#E8CE40' ) ?>" style="background-color: <?php echo esc_attr( self::get_field( 'icon_border_color', '#E8CE40' ) ) ?>" />
							</td>
						</tr>
						<tr valign="top">
							<th scope="row">
							...
							<td>
								<div class="vi-ui toggle checkbox">
									<input id="<?php echo self::set_field( 'hide_title' ) ?>" type="checkbox" <?php checked( self::get_field( 'hide_title' ), 1 ) ?> tabindex="0" class="hidden" value="1" name="<?php echo self::set_field( 'hide_title' ) ?>" />
									<label></label>
								</div>
						...
						<tr valign="top">
							...
							<td>
								<input type="text" class="color-picker" name="<?php echo self::set_field( 'title_color' ) ?>" value="<?php echo self::get_field( 'title_color', '#212121' ) ?>" style="background-color: <?php echo esc_attr( self::get_field( 'title_color', '#212121' ) ) ?>" />
							</td>
						</tr>
						<tr valign="top">
							<th scope="row">
							...
							<td>
								<input type="text" class="color-picker" name="<?php echo self::set_field( 'title_background_color' ) ?>" value="<?php echo self::get_field( 'title_background_color', '#eee' ) ?>" style="background-color: <?php echo esc_attr( self::get_field( 'title_background_color', '#212121' ) ) ?>" />
							</td>
						</tr>
						</tbody>
					</table>
					...
					<table class="optiontable form-table">
						...
						<tr valign="top">
							...
							<td>
								<input type="text" class="color-picker" name="<?php echo self::set_field( 'text_color' ) ?>" value="<?php echo self::get_field( 'text_color', '#E8CE40' ) ?>" style="background-color: <?php echo esc_attr( self::get_field( 'text_color', '#E8CE40' ) ) ?>" />
							</td>
						</tr>
						<tr valign="top">
							<th scope="row">
							...
							<td>
								<input type="text" class="color-picker" name="<?php echo self::set_field( 'background_color' ) ?>" value="<?php echo self::get_field( 'background_color', '#fff' ) ?>" style="background-color: <?php echo esc_attr( self::get_field( 'background_color', '#fff' ) ) ?>" />
							</td>
						</tr>
						<tr valign="top">
							<th scope="row">
						...
						<tr valign="top">
							...
							<td>
								<div class="vi-ui toggle checkbox">
									<input id="<?php echo self::set_field( 'close_button' ) ?>" type="checkbox" <?php checked( self::get_field( 'close_button' ), 1 ) ?> tabindex="0" class="hidden" value="1" name="<?php echo self::set_field( 'close_button' ) ?>" />
									<label></label>
								</div>
								<p class="description"></p>
							</td>
						...
						<tr valign="top">
							...
							<td>
								<div class="vi-ui toggle checkbox">
									<input id="<?php echo self::set_field( 'see_more' ) ?>" type="checkbox" <?php checked( self::get_field( 'see_more' ), 1 ) ?> tabindex="0" class="hidden" value="1" name="<?php echo self::set_field( 'see_more' ) ?>" />
									<label></label>
								</div>
								<p class="description"></p>
							</td>
					...
					<table class="optiontable form-table">
						...
						<tr valign="top">
							...
							<td>
								<div class="vi-ui toggle checkbox">
									<input id="<?php echo self::set_field( 'slide_pagination' ) ?>" type="checkbox" <?php checked( self::get_field( 'slide_pagination' ), 1 ) ?> tabindex="0" class="hidden" value="1" name="<?php echo self::set_field( 'slide_pagination' ) ?>" />
									<label></label>
								</div>
								<p class="description"></p>
							</td>
						...
						<tr valign="top">
							...
							<td>
								<div class="vi-ui toggle checkbox">
									<input id="<?php echo self::set_field( 'slide_navigation' ) ?>" type="checkbox" <?php checked( self::get_field( 'slide_navigation' ), 1 ) ?> tabindex="0" class="hidden" value="1" name="<?php echo self::set_field( 'slide_navigation' ) ?>" />
									<label></label>
								</div>
								<p class="description"></p>
							</td>
						...
						<tr valign="top">
							...
							<td>
								<div class="vi-ui toggle checkbox">
									<input id="<?php echo self::set_field( 'slide_auto_play' ) ?>" type="checkbox" <?php checked( self::get_field( 'slide_auto_play' ), 1 ) ?> tabindex="0" class="hidden" value="1" name="<?php echo self::set_field( 'slide_auto_play' ) ?>" />
									<label></label>
								</div>
								<p class="description"></p>
							</td>
				...
				<div class="vi-ui bottom attached tab segment" data-tab="instagram">
					...
					<ul>
						<li><?php echo esc_html__( '1. Go to ', 'woo-lookbook' ) ?><a target="_blank"
																					  href="https://www.instagram.com/developer/">https://www.instagram.com/developer/</a>
						</li>
						<li><?php echo esc_html__( '2. Click Register Your Application button and click Register new Client ID', 'woo-lookbook' ) ?></li>
						<li><?php echo esc_html__( '3. Copy', 'woo-lookbook' ) ?>
							<i><?php echo admin_url( 'edit.php?post_type=woocommerce-lookbook&page=woocommerce-lookbook-settings' ) ?></i>
							<?php echo esc_html__( 'to Valid redirect URIs field', 'woo-lookbook' ) ?>
						</li>
					...
					<table class="optiontable form-table">
						...
						<tr valign="top">
							...
							<td>
								<input type="text" name="<?php echo self::set_field( 'ins_access_token' ) ?>"
									   value="<?php echo self::get_field( 'ins_access_token', '' ) ?>" <?php echo self::get_field( 'ins_access_token', '' ) ? '' : 'disabled="disabled"' ?>/>
								<?php if ( ! self::get_field( 'ins_access_token', '' ) && self::get_field( 'ins_client_id', '' ) && self::get_field( 'ins_client_secret', '' ) ) { ?>
									<p>
                                    <span data-href="https://api.instagram.com/oauth/authorize/?client_id=<?php echo self::get_field( 'ins_client_id', '' ) ?>&redirect_uri=<?php echo urlencode( admin_url( 'edit.php?post_type=woocommerce-lookbook&page=woocommerce-lookbook-settings' ) ) ?>&response_type=code"
										  class="vi-ui button green wlb-get-access-token"><?php esc_html_e( 'Get Access Token', 'woo-lookbook' ) ?></span>
									</p>
								<?php } ?>
								<p class="description">
									<?php echo esc_html__( 'You must fill Client ID and Client Secret to get Access token', 'woo-lookbook' ) ?>
								</p>
						...
						<tr valign="top">
							...
							<td>
								<div class="vi-ui toggle checkbox">
									<input id="<?php echo self::set_field( 'ins_link' ) ?>" type="checkbox" <?php checked( self::get_field( 'ins_link' ), 1 ) ?> tabindex="0" class="hidden" value="1" name="<?php echo self::set_field( 'ins_link' ) ?>" />
									<label></label>
								</div>
							</td>
						</tr>
