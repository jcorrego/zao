        ...
        <div class="card p-0 mb-4">
          ...
          <div class="card-body">
            <?php if(!is_writable(AGILESTORELOCATOR_PLUGIN_PATH.'public/icon')): ?>
              <h3  class="alert alert-danger" style="font-size: 14px"><?php echo AGILESTORELOCATOR_PLUGIN_PATH.'public/icon' ?> <= <?php echo __('Directory is not writable, Logo Image Upload will Fail, Make directory writable.','asl_admin') ?></h3>  
            <?php endif; ?>
            <div class="row mb-3">
