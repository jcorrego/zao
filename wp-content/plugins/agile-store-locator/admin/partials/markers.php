      ...
      <div class="col-md-12">
        <div class="card p-0 mb-4">
          ...
          <?php if(!is_writable(AGILESTORELOCATOR_PLUGIN_PATH.'public/icon')): ?>
            <h6  class="alert alert-danger" style="font-size: 14px"><?php echo AGILESTORELOCATOR_PLUGIN_PATH.'public/icon' ?> <= <?php echo __('Directory is not writable, Marker Image Upload will Fail, Make directory writable.','asl_admin') ?></h6>
          <?php endif; ?>
            <div class="row mb-3">
